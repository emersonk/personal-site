...
Light Heart was a product built during my time at CoreHealth. I spearheaded project, leading the research, development, implementation 
of its algorithms as well as the entire product architecture. The main motivation for its development 
